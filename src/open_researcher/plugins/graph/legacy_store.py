...
Migrated from ``open_researcher.research_graph``.  This is the file-based
JSON store used by the original research loop.  The SQLite-backed
``GraphStore`` in ``store.py`` is the long-term replacement.
"""
...
from open_researcher.plugins.graph.constants import (
    BRANCH_RELATIONS,
    CLAIM_REASON_CODES,
    CLAIM_STATES,
    CLAIM_TRANSITIONS,
...
from open_researcher.plugins.storage.file_ops import locked_read_json, locked_update_json
